...
class Install extends Migration
{
    public function safeUp(): bool
    {
        ...
        $this->createTable('{{%formsprocessor_pdf_templates}}', [
            ...
            'bodyTwig'    => $this->mediumText()->notNull(),
            'headerTwig'  => $this->text()->notNull(),
            'footerTwig'  => $this->text()->notNull(),
            'sampleData'  => $this->mediumText()->notNull(),
